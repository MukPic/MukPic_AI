...
# 클래스, 제외할 클래스
class_names = [
    '잡곡밥', '보리밥', '흑미밥', '김치볶음밥', '볶음밥', '비빔밥', '새우볶음밥', '알밥', 
    ...
    '해물덮밥', '돼지국밥', '유부초밥', '김밥', '김치말이국수', '닭칼국수', '들깨칼국수', '라면', '막국수',
      ...
      '배추된장국', '선지해장국', '시금치된장국', '우거지된장국', '우거지해장국', '갈비탕', '감자탕', '매운탕', 
      ...
      '돼지고기볶음', '돼지껍데기볶음', '소세지볶음', '순대볶음', '오리불고기', '오삼불고기', '떡볶이', '라볶이', '갈치조림', 
